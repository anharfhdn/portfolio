...
export default function About() {
  const coreStack = [
    {
      ...
      description:
        "Secure smart contracts, gas optimization, and EVM-compatible protocols.",
    },
    {
      name: "Backend Architecture",
      icon: <Database size={20} />,
      description:
        "Scalable schemas, system integration, and high-performance APIs for B2B.",
    },
    {
      name: "Frontend & Mobile",
      icon: <Globe size={20} />,
      description:
        "Modern web applications and mobile interfaces with Vue, Next.js, and Kotlin.",
    },
    {
      name: "Industrial & IoT",
      icon: <Cpu size={20} />,
      description:
        "Production automation and hardware-to-cloud integration using PLC and ESP32.",
    },
  ];
  ...
  const technicalSkills = [
    ...
    },
    {
      category: "Backend (BE)",
      items:
        "Go, PHP, JavaScript, Kotlin, PostgreSQL, MySQL, MSSQL, CodeIgniter",
    },
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-4 text-lg text-muted-foreground leading-relaxed mb-10">
              <p>
                Engineering robust software at the intersection of{" "}
                <strong>Industrial Automation</strong> and{" "}
                <strong>Decentralized Protocols</strong>. Focused on creating
            ...
            <div className="space-y-6 border-l-2 border-emerald-500/20 pl-6 mb-10">
              {technicalSkills.map((skill) => (
                <div key={skill.category}>
                  <h4 className="text-xs font-mono uppercase tracking-[0.2em] text-emerald-600 mb-2">
                    {skill.category}
                  </h4>
