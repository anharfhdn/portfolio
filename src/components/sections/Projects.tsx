...
export default function Projects() {
    const projects: Project[] = [
        {
            ...
            tags: ["Web3", "Solidity", "Smart Contract", "NextJs", "Ponder", "PostgreSQL", "IPFS"],
            github: "#",
        },
        {
        ...
        },
        {
            ...
            tags: ["Web3", "Solidity", "Smart Contract", "NextJs", "Ponder", "PostgreSQL"],
            github: "#",
        },
        {
            title: "Barcode Gas System",
            client: "PT. Iwatani Industrial Gas Indonesia",
            description: "Create Production, Quality Control, and Maintenance Android Applications.",
        ...
        },
        {
            ...
            description: "Developed a final project using UHF RFID to track personal protective equipment.",
    ...
    return (
        <section id="projects" className="py-32 relative grid-bg bg-emerald-50/30 dark:bg-emerald-950/10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-6">
                    ...
                    <div className="relative">
                        <p className="text-muted-foreground text-xs md:text-sm font-medium max-w-[260px] leading-relaxed border-l-2 border-emerald-500/20 pl-4 py-1">
                            A documented history of <span className="text-foreground">production-grade</span> software across Industrial IoT and Web3 ecosystems.
                        </p>
                    </div>
                </div>
                            ...
                            <div className="p-7 flex flex-col flex-1">
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {project.tags.map((tag) => (
                                        <span key={tag} className="text-[10px] font-mono font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/10">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
                                ...
                                <div className="flex items-center justify-between pt-5 border-t border-emerald-500/10">
                                    {project.github === "#" ? (
                                        <div className="flex items-center gap-2 text-[10px] font-mono text-muted-foreground/60">
                                            ...
                                            <span className="uppercase tracking-tighter">Enterprise Protected</span>
                                        </div>
                                    ) : (
                                        <a href={project.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[10px] font-mono font-bold hover:text-emerald-500 transition-colors uppercase tracking-tighter">
